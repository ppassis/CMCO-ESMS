  ...
  <Layout class="outils-page">
    ...
    <div class="cover">
     <div class="cover__container">
      ...
      <p class="cover__subtitle">De nombreux outils sont déjà disponibles, certains en cours de développement, d'autres à imaginer... <br>Des outils pour améliorer la coopération et la mutualisation de compétences et d'outils entre les Etablissements et Sercices Sociaux et Médico-Sociaux.</p>
    ...
    <div class="content">
      ...
      <section>
        <h2><Outils class="h2__icon" focusable="false" aria-hidden="true"/>Tests usagers en situation de handicap</h2>
