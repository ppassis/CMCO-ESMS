<template>
  <Layout class="signin-page" hideNewsletter>
    ...
    <div class="cover">
     <div class="cover__container">
       ...
       <h1 lang="en" class="text-highlight">S'enregistrer</h1>

      </div>

      <p class="cover__subtitle">
        Créer votre compte utilisateur, vous permet de proposer vos actions de coopération et mutualisation, de consulter la fiche d'identité complète du porteur de l'action pour entrer en contact et vous joindre à l'action.
      </p>
    ...
    <div class="content">
      ...
      <form action="https://gouv.us5.list-manage.com/subscribe/post?u=c921e95d674341b87fd4fb6e6&amp;id=bc185cd5f1" method="post" name="mc-embedded-subscribe-form" target="_blank" rel="noreferrer noopener">
        ...
        <div class="clear"><input type="submit" value="Je crée mon compte" title="Je crée mon compte" name="signin" id="mc-embedded-subscribe" class="button"></div>
